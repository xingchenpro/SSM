...
public class MixIndex {
    public static void main(String [] arv){
        ...
        if(file>(10+bsize/bnsize+Math.pow((bsize/bnsize),5))*bsize){
            ...
            if(count<=10){
                ...
                if(file%bsize==0)
                    System.out.println("若为地址则快内地址为"+bsize);
                else
                    System.out.println("若为地址则快内地址为"+(file/bsize - 1));
            }
